...
namespace Ax3.IMS.DataAccess.Mongo
{
    ...
    public interface IRepository<T> where T : IMongoEntity
    {
        ...
        /// <summary>
        /// find entities with paging and ordering async
        /// </summary>
        /// <param name="filter"></param>
        ...
        /// <param name="updates">updated field(s)</param>
        /// <returns>true if successful, otherwise false</returns>
        long Update(Expression<Func<T, bool>> filter, params UpdateDefinition<T>[] updates);
        ...
        /// <param name="filter">collection filter</param>
        /// <param name="updates">updated field(s)</param>
        Task<long> UpdateAsync(Expression<Func<T, bool>> filter, params UpdateDefinition<T>[] updates);
        #endregion Update
